...
public class GuiAPEUStorage extends GuiContainer {
	private rtTEAPEUStorage tile;
	public GuiAPEUStorage(InventoryPlayer inventory, rtTEAPEUStorage tileEntity) {
		super(new rtCountainerAPEUStorage(inventory, tileEntity));
    ...
    protected void drawGuiContainerForegroundLayer(int par1, int par2) {
     ...
     this.fontRendererObj.drawString(StatCollector.translateToLocal("PEUAStorage"), 59, 6, 4210752);//
