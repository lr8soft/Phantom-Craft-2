...
public class GuiRECT extends GuiContainer {
	private rtTERECT tile;
	public GuiRECT(InventoryPlayer inventory, rtTERECT tileEntity) {
		super(new rtCountainerRECT(inventory, tileEntity));
    ...
    protected void drawGuiContainerForegroundLayer(int par1, int par2) {
     ...
     this.fontRendererObj.drawString(StatCollector.translateToLocal("ReCustomTable"), 55, 6, 4210752);//
   ...
   //  drawString(FontRenderer,str,x,y,c)
	...
	protected void drawGuiContainerBackgroundLayer(float var1, int var2,
        ...
        this.mc.renderEngine.bindTexture(new ResourceLocation("phtc2","textures/gui/RECustomTable.png"));
