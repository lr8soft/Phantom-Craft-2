...
public class rtCountainerAPEUStorage extends Container {
    private rtTEAPEUStorage tile;
	private long lastTablePEU = 0;
	private long lastMaxPEU = 500000;

    public rtCountainerAPEUStorage(InventoryPlayer par1InventoryPlayer, rtTEAPEUStorage par2TileEntityRepairTable)
    {
    	tile = par2TileEntityRepairTable;
    	
        this.addSlotToContainer(new Slot(par2TileEntityRepairTable, 0, 34, 19));
        this.addSlotToContainer(new Slot(par2TileEntityRepairTable, 1, 34, 40));
        int var3;
