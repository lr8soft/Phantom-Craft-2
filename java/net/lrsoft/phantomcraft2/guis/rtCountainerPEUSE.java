...
public class rtCountainerPEUSE extends Container {
    private rtTEPEUSE tile;
	private long lastTablePEU = (long) 0;
	private long lastMaxPEU = (long) 50000;

    public rtCountainerPEUSE(InventoryPlayer par1InventoryPlayer, rtTEPEUSE par2TileEntityRepairTable)
    {
	...
	public void detectAndSendChanges() {
		...
		this.lastTablePEU = (int) this.tile.tablePEU;
