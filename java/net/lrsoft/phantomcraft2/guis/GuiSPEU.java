...
public class GuiSPEU extends GuiContainer {
	private rtTESPEU tile;
	public GuiSPEU(InventoryPlayer inventory, rtTESPEU tileEntity) {
		super(new rtCountainerSPEU(inventory, tileEntity));
    ...
    protected void drawGuiContainerForegroundLayer(int par1, int par2) {
     ...
     this.fontRendererObj.drawString(StatCollector.translateToLocal("PEUSolar"), 65, 6, 4210752);//
     ...
     this.fontRendererObj.drawString(StatCollector.translateToLocal("UpSlot Output"), 67, 42, 4210752);
   ...
   //  drawString(FontRenderer,str,x,y,c)
	...
	protected void drawGuiContainerBackgroundLayer(float var1, int var2,
        ...
        this.mc.renderEngine.bindTexture(new ResourceLocation("phtc2","textures/gui/SPEU.png"));
