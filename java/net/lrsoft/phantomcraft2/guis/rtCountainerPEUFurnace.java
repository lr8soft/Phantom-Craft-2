...
public class rtCountainerPEUFurnace extends Container {
    private rtTEPEUFurnace tile;
	private int lastTablePEU = 0;
	private int lastMaxPEU = 500;

    public rtCountainerPEUFurnace(InventoryPlayer par1InventoryPlayer, rtTEPEUFurnace par2TileEntityRepairTable)
    {
