...
public class GuiPEUSE extends GuiContainer {
	private rtTEPEUSE tile;
	public GuiPEUSE(InventoryPlayer inventory, rtTEPEUSE tileEntity) {
		super(new rtCountainerPEUSE(inventory, tileEntity));
    ...
    protected void drawGuiContainerForegroundLayer(int par1, int par2) {
     ...
     this.fontRendererObj.drawString(StatCollector.translateToLocal("PEU Poly Energy Converter"), 60, 6, 4210752);//
