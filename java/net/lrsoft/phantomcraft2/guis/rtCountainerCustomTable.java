...
public class rtCountainerCustomTable extends Container {
    private rtTECustomTable tile;
	private int lastTablePEU = 0;
	private int lastMaxPEU = 2000;

    public rtCountainerCustomTable(InventoryPlayer par1InventoryPlayer, rtTECustomTable par2TileEntityRepairTable)
    {
