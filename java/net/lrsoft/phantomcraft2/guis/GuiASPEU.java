...
public class GuiASPEU extends GuiContainer {
	private rtTEASPEU tile;
	public GuiASPEU(InventoryPlayer inventory, rtTEASPEU tileEntity) {
		super(new rtCountainerASPEU(inventory, tileEntity));
    ...
    protected void drawGuiContainerForegroundLayer(int par1, int par2) {
     ...
     this.fontRendererObj.drawString(StatCollector.translateToLocal("Advanced PEUSolar"), 55, 6, 4210752);//
   ...
   //  drawString(FontRenderer,str,x,y,c)
	...
	protected void drawGuiContainerBackgroundLayer(float var1, int var2,
        ...
        this.mc.renderEngine.bindTexture(new ResourceLocation("phtc2","textures/gui/ASPEU.png"));
