...
public class rtCountainerPEUStorage extends Container {
    private rtTEPEUStorage tile;
	private long lastTablePEU = 0;
	private long lastMaxPEU = 50000;

    public rtCountainerPEUStorage(InventoryPlayer par1InventoryPlayer, rtTEPEUStorage par2TileEntityRepairTable)
    {
