...
public class rtCountainerRecycle extends Container {
    private rtTERecycle tile;
	private int lastTablePEU = 0;
	private int lastMaxPEU = 2000;

    public rtCountainerRecycle(InventoryPlayer par1InventoryPlayer, rtTERecycle par2TileEntityRepairTable)
    {
