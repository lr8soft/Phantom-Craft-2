...
public class blockCustomTable extends BlockContainer{
	...
	protected blockCustomTable(Material material) {
		super(material);
	}
	@Override
	public TileEntity createNewTileEntity(World p_149915_1_, int p_149915_2_) {
		// TODO Auto-generated method stub
		return new rtTECustomTable();
	}
	  public void breakBlock(World world, int x, int y, int z, Block block, int meta)
	  {
	    TileEntity te = world.getTileEntity(x, y, z);
	    if ((te != null) && ((te instanceof rtTECustomTable)))
	    {
	    	rtTECustomTable ct = (rtTECustomTable)te;
...
{
  player.openGui(phantomcraft2.instance, 2018302001, world, i, j, k);
 return true;
}
@SideOnly(Side.CLIENT)
public void registerBlockIcons(IIconRegister iconRegister)
{
 ...
 this.iconTop = iconRegister.registerIcon("phtc2:CT_p2");
}
