...
public class blockRECT extends BlockContainer{
	private final Random raaaadom = new Random();
	  @SideOnly(Side.CLIENT)
	  private IIcon iconFront;
	  @SideOnly(Side.CLIENT)
	  private IIcon iconTop;
	protected blockRECT(Material material) {
		super(material);
	}
	@Override
	public TileEntity createNewTileEntity(World p_149915_1_, int p_149915_2_) {
	  ...
	  public void breakBlock(World world, int x, int y, int z, Block block, int meta)
	  {
	    ...
	    if ((te != null) && ((te instanceof rtTERECT)))
	    {
	    	rtTERECT ct = (rtTERECT)te;
...
{
player.openGui(phantomcraft2.instance, 2018311001, world, i, j, k);
return true;
}
@SideOnly(Side.CLIENT)
...
this.iconTop = iconRegister.registerIcon("phtc2:RECT_p2");
}
