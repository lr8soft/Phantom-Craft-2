...
public class blockstateexchange extends BlockContainer{
	  @SideOnly(Side.CLIENT)
	  private IIcon iconFront;
	  @SideOnly(Side.CLIENT)
	  private IIcon iconTop;
	protected blockstateexchange(Material material) {
		super(material);
	}
	@Override
	public TileEntity createNewTileEntity(World p_149915_1_, int p_149915_2_) {
		// TODO Auto-generated method stub
		return new rtTEStateExchange();
	}
	private final Random raaaadom = new Random();
	  public void breakBlock(World world, int x, int y, int z, Block block, int meta)
	  {
	    TileEntity te = world.getTileEntity(x, y, z);
	    if ((te != null) && ((te instanceof rtTEStateExchange)))
	    {
	    	rtTEStateExchange storage = (rtTEStateExchange)te;
    ...
    {
        player.openGui(phantomcraft2.instance, 2018216001, world, i, j, k);
        return true;
    }
    @SideOnly(Side.CLIENT)
    public void registerBlockIcons(IIconRegister iconRegister)
    {
      this.blockIcon = iconRegister.registerIcon("phtc2:se_p1");
      this.iconFront = iconRegister.registerIcon("phtc2:se_p1");
      this.iconTop = iconRegister.registerIcon("phtc2:se_p2");
    }
